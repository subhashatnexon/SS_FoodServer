report 61304 "NXN-Purchase Order_FS"
{
    // <changelog>
    ...
    // </changelog>
    DefaultLayout = RDLC;
    RDLCLayout = './Rep61304.NXN-Purchase Order_FS.rdlc';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(Header_Amount_Excl_GST; "Purchase Header".Amount)
            {
            }
            column(Header_Amount_Incl_GST; "Purchase Header"."Amount Including VAT")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocDate_PurchHdr; Format("Purchase Header"."Document Date", 0, '<Day> <Month text,3> <Year4>'))
                    {
                    }
                    ...
                    column(Currency_Code; "Purchase Line"."Currency Code")
                    {
                    }
                    ...
                    {
                        DataItemTableView = SORTING(Number);
                        column(PurchaseLine_Unit_of_Measure; "Purchase Line"."Unit of Measure Code")
                        {
                        }
                        ...
                        column(VendItemNo; "Purchase Line"."Vendor Item No.")
                        {
                        }
